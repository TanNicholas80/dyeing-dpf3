...
class BarcodeLa extends Model
{
    ...
    public function detailProses()
    {
        return $this->belongsTo(DetailProses::class, 'detail_proses_id', 'id');
                ...
                /**
     * Konfigurasi logging untuk model BarcodeLa.
     */
    ...
    public function tapActivity(Activity $activity, string $eventName): void
    {
        ...
        switch ($eventName) {
            case 'created':
                $activity->description = "BarcodeLa '{$this->no_op}' berhasil dibuat";
            ...
            case 'deleted':
                $activity->description = "BarcodeLa '{$this->no_op}' telah dihapus";
                $activity->properties = $activity->properties->merge([
                    'event_type' => 'deleted',
